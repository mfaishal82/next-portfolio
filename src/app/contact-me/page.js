      ...
      <div className="grid grid-cols-2 text-[14px] border-[#1E2D3D] text-[#607B96] h-full">
        <div className="flex flex-col max-sm:col-span-2 border-r-2 border-[#1E2D3D] p-3 pt-10 gap-5">
          <form onSubmit={sendEmail} className="w-[80%] self-center">
            <div className="mb-5">
              <label className="block text-[#607B96] text-[14px] mb-2">
                _name:
              </label>
              <input
                name="from_name"
            ...
            <div>
              <button className="bg-[#1C2B3A] text-white hover:bg-[#607B96] hover:text-[#1E2D3D] text-[14px] py-1 px-3 rounded-md">
                submit-message
              </button>
            </div>
          </form>
          <div className="w-[80%] self-center bg-[#1E2D3D] ">
            <p className="text-[#607B96] text-[14px] p-3">
              $ <span className="text-[#43D9AD]">{status}</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col border-r-2 border-[#1E2D3D] p-3 pt-10 gap-5 max-sm:hidden">
          <div className="self-center">
            ...
            <span className="text-[#C98BDF]">=</span> {"{"} <br />
            <span className="ml-3">
            ...
            <span className="ml-3">
              ...
              <span className="text-[#FEA55F]">
                "{new Date().toLocaleDateString("en-EN", options)}"
              </span>
            </span>{" "}
            <br />
            {"}"}
