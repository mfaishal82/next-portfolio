...
export default function Header() {
  ...
  return (
    <header className="grid grid-cols-4 m-0 p-0 text-[#607B96] text-[14px] sticky top-0 z-[9999] bg-[#011627] w-full">
      <div className="flex flex-row items-center gap-2 border-r-2 border-b-2 max-sm:border-none border-[#1E2D3D] p-3 cursor-default select-none text-[#43D9AD] max-sm:col-span-4">
        muhammad-faisal
