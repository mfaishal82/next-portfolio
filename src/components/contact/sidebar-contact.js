    ...
    return (
        <>
            ...
            <div>
                ...
                <a href="/Muhammad_Faisal_Resume.pdf" download={"Muhammad_Faisal_Resume"}>
                    <div className="border-b-2 border-[#1E2D3D] p-2 text-[#607B96] hover:text-white flex flex-row gap-2 items-center">
