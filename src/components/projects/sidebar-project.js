    ...
    <>
      ...
      <div className="border-b-2 border-[#1E2D3D] text-[#607B96] flex flex-col gap-2 justify-center p-2 py-4">
        ...
        listProjects.map((project, index) => (
          project.type === "web" &&
          <button key={index} className="flex flex-row hover:text-white cursor-pointer gap-2 items-center text-[#607B96] ml-6 mt-1">
              ...
              <span className="ml-1">_{project.title}</span>
          </button>
          ))
        }
